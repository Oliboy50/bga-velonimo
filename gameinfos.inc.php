...
$gameinfos = [
    ...
    // 'not_recommend_player_number' => [2, 3],      // <= example: this is not recommended to play this game with 2 or 3 players
    ...
    // If an array of shortcode languages such as [1 => 'en', 2 => 'fr', 3 => 'it'] then all players at the table must speak the same language, and this language must be one of the listed languages.
    ...
    'presentation' => [
        totranslate('The card game Velonimo allows you to depict the merciless struggle in the animal world for the distinctive and highly prized "petits pois-carottes" jersey rewarded to the best climbing cyclist.'),
    ],
